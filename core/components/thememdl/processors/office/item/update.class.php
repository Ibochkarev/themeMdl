 ...
 * Update an Item
 */
class themeMdlOfficeItemUpdateProcessor extends modObjectUpdateProcessor {
	...
	public function beforeSet() {
		...
		if (empty($id)) {
			return $this->modx->lexicon('thememdl_item_err_ns');
		}
...
return 'themeMdlOfficeItemUpdateProcessor';
