...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('thememdl_core_path', null, $modx->getOption('core_path') . 'components/thememdl/') . 'model/';
            $modx->addPackage('thememdl', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/thememdl/model/schema/thememdl.mysql.schema.xml';
